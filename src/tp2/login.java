...
public class login extends javax.swing.JFrame {
    ...
    public void cekData() {
          // get data
          try{
              String kodeGroup = kodeLogin.getText();
              String password = passLogin.getText();
          
              if(!kodeGroup.isEmpty() && !password.isEmpty()){
                String sql = "SELECT * FROM idol_group "
                        + "WHERE kode_group='" + kodeGroup + "' and pass_group='" + password + "'";
                ...
                if(res.next()){
                    ...
                    this.dispose();
                    // pindah ke home page
                    JPanelCard home = new JPanelCard(kodeGroup);
                    home.setVisible(true);
                }
              }
              else{
                  JOptionPane.showMessageDialog(null, "Kode or password is empty!");
              }
    ...
    private void initComponents() {
        ...
        kodeLogin = new javax.swing.JTextField();
        ...
        kodeLogin.setBackground(new java.awt.Color(255, 255, 255));
        kodeLogin.setForeground(new java.awt.Color(0, 0, 0));
        kodeLogin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                kodeLoginActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(kodeLogin)
                            .addComponent(passLogin, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(100, 100, 100)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(kodeLogin, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void kodeLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kodeLoginActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_kodeLoginActionPerformed
    ...
    private javax.swing.JTextField kodeLogin;
